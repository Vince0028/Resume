...
const TerminalInput = ({ onSubmit, disabled, autoFocusEnabled = true, disableNativeKeyboard = false }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('terminal-virtual-key', handler);
    return () => window.removeEventListener('terminal-virtual-key', handler);
  }, [value, onSubmit]);
