...
import { THEME_BORDER, THEME_COLOR, THEME_BG, FILE_SYSTEM } from '../constants';

const FileExplorer = ({ isSpookyActive = false }) => {
  const rootNode = {
    name: '~',
    type: 'dir',
  ...
  const [pathStack, setPathStack] = useState([rootNode]);
